...
👨‍💻 **Developer :** [Fayas](https://github.com/tedzo01)

📢 **Channel :** [Fayas Noushad](https://telegram.me/tedzo01)

🌐 **Source :** [👉 Click here](https://github.com/tedzo01/Telegraph-Uploader-Bot-V2__)
...
@Bot.on_message(filters.private & filters.command(["startt"]))
    ...
    await text.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton(text="⚙ Join Updates Channel ⚙", url="https://telegram.me/tedzo01")]
            ]
        )
    )
